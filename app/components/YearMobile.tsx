  ...
  return (
    <article className="grid grid-row-1 pl-4">
      <div className="border-l-2 border-black dark:border-white">
        <h3 className="relative max-w-[11rem] sm:max-w-[13rem] pl-10 max-sm:pl-4 border-0 border-b-2 border-solid text-black dark:text-white">
          {data.year}
      ...
      <div className="border-0 border-l-2 border-solid border-black dark:border-white">
        <div className="p-10 pl-[2.75rem] max-sm:pl-4 max-sm:pt-4 pt-14 max-w-[50rem] leading-5 text-black dark:text-white">
          {data.image ? (
            <>
              <Image
                src={`${data.image.url}`}
